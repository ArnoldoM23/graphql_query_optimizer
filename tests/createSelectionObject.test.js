...
describe('createSelectionObject', () => {
  ...
  test('should handle nested object types', () => {
    ...
    expect(selection.user.posts).toEqual(expect.objectContaining({
      id: false,
      title: false,
      content: false,
    ...
    expect(selection.user.posts.author).toEqual(expect.objectContaining({
      id: false,
      name: false,
      email: false
    }));
  ...
  test('should handle circular references', () => {
    ...
    expect(selection.person.bestFriend).toEqual(expect.objectContaining({
      id: false,
      name: false
    }));
    
    // Check that arrays with circular references are handled correctly
    expect(selection.person.friends).toEqual(expect.objectContaining({
      id: false,
      name: false
    }));
  });
